/**
 * mouse x and y : cell width and cell height
 * ENTER : export pdf
 * 1 or 2 : background color
 * a, z or e : line 0 stroke cap
 * u or i : line 0 color
 * o or p : line 0 alpha
 * q, s or d : line 1 stroke cap
 * j or k : line 1 color
 * l or m : line 1 alpha
 */
...
void mouseMoved() {
  strokeWeight0 = round(map(mouseX, 0, width, 1, cellWidth * 1.5));
  strokeWeight1 = round(map(mouseY, 0, height, 1, cellHeight * 1.5));
}
